        ...
        <div class="bg-white rounded-lg p-8" :style="{ opacity: 0.8 }">
          ...
          <div class="mb-10">
            ...
            <p class="flex items-center">
              ...
              <nuxt-link to="/sermons" :class="linkClass"
                >Listen to previous sermons</nuxt-link
              >
            </p>
          </div>
          <!--Contact Section-->
          <div class>
            ...
            <p class="flex items-center mb-6">
              ...
              <a href="#" :class="linkClass" v-scroll-to="'#contact-us'"
                >Contact us</a
              >
            </p>
            <p class="flex items-center">
              ...
              <a href="#" :class="linkClass" v-scroll-to="'#map'"
                >See our location</a
              >
            </p>
          </div>
