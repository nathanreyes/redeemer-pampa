export const beliefs = [
  ...
  {
    title: "Man's Responsiveness To the Gospel",
    description:
  ...
  {
    title: "Man's Inheritance Through the Gospel",
    description:
  ...
  },
  {
    ...
    description:
      'Water baptism is intended only for the individual who has received the saving benefits of Christ’s atoning work and has become His disciple. Therefore, in obedience to Christ’s command and as a testimony to God, the Church, oneself, and the world, a believer should be immersed in water in the name of the Father, Son, and Holy Spirit. Water baptism is a visual symbolic demonstration of a person’s union with Christ in the likeness of His death and resurrection. It signifies that his former way of life has been put to death, and vividly depicts a person’s release from the mastery of sin. As with water baptism, the Lord’s Supper is to be observed only by those who have become genuine followers of Christ. This ordinance symbolizes the breaking of Christ’s body and the shedding of His blood on our behalf, and is to be observed repeatedly throughout the Christian life as a sign of continued participation in the atoning benefits of Christ’s death. As we partake of the Lord’s Supper with an attitude of faith and self-examination, we remember and proclaim the death of Christ, receive spiritual nourishment for our souls, and signify our unity with other members of Christ’s body.',
  },
  {
...
export const gospelCommunities = [
  {
    time: 'Sundays @ 5:30pm',
    hosts: 'Jeremy & Karmen Buck, Reagan & Carol Herman',
    address: '815 N. Somerville St.',
    moreInfo:
      'Contact <a href="mailto:jbuck.redeemerpampa@gmail.com" class="link-small">jbuck.redeemerpampa@gmail.com</a> for more info',
  },
  {
    time: 'Sundays @ 6:00pm',
    ...
    moreInfo:
      'Contact <a href="mailto:haymckay3@gmail.com" class="inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker no-underline">haymckay3@gmail.com</a> for more info',
  },
  {
    time: 'Sundays @ 5:30pm',
    ...
    moreInfo:
      'Contact <a href="mailto:marygrace.rayburn@gmail.com" class="inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker no-underline">marygrace.rayburn@gmail.com</a> for more info',
  },
  {
    ...
    moreInfo:
      'This group rotates location monthly. Text Lori at <a href="tel:1-806-662-2542" class="inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker no-underline">806.662.2542</a> for current location.',
  },
  {
    ...
    moreInfo:
      'Contact <a href="mailto:michael@pampasleepsource.com" class="inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker no-underline">michael@pampasleepsource.com</a> for more info',
  },
  {
    time: 'Wednesdays @ 6:30pm',
    hosts: 'Jesse and Marissa Lee',
    address: '2128 Lynn St.',
    subaddress: 'Students Only, 6th - 12th Grades',
    moreInfo:
      'Contact <a href="mailto:j_doyle_lee@yahoo.com" class="inline-block align-baseline font-bold text-sm text-blue hover:text-blue-darker no-underline">j_doyle_lee@yahoo.com</a> for more info',
  },
];
...
export const staffProfiles = [
  {
    ...
    role: 'Elder',
    imgUrl:
      'https://res.cloudinary.com/dqgcfqzpk/image/upload/c_crop,h_600,w_600,x_420,y_100/v1530713511/redeemer-pampa/Rex_McKay.jpg',
    email: 'haymckay3@gmail.com',
    description:
      'Rex is a local businessman and farmer who graduated from White Deer High School in 1983. He has been married to his wife, Robin, since 1984. Together they have three children; Will, Mary (& husband Taylor), and Mason.',
  },
  {
    name: 'TV Cuellar',
    role: 'Elder',
    imgUrl:
      'https://res.cloudinary.com/dqgcfqzpk/image/upload/c_crop,h_400,w_400,x_220,y_440/v1530714527/redeemer-pampa/TV_Cuellar.jpg',
    email: 'primitivo.cuellar@accoladehomecare.com',
    description:
      'TV is the branch director of a local home health care office. He graduated from Pampa High School in 1985 after moving to Pampa in 1980. He has been married to his wife, Yvette, since 1992 and he has two sons; Luke (& wife Amanda) and Paul (& wife Alison) and two grandchildren.',
  },
  {
    name: 'Jeremy Buck',
    role: 'Lead Pastor, Elder',
    imgUrl:
      'https://res.cloudinary.com/dqgcfqzpk/image/upload/c_crop,w_180,x_210,y_10/v1530715706/redeemer-pampa/Jeremy_Buck.jpg',
    email: 'jbuck.redeemerpampa@gmail.com',
    description:
      'Jeremy is on paid staff at Redeemer Pampa. He was born and raised in Pampa and graduated from Pampa High School in 2000. He and his wife, Karmen, have been married since December of 2002. Together they have one daughter, Karsen, and one son, Jude.',
  },
];
...
export const contact = {
  header: 'CONTACT US',
  name: 'Redeemer Pampa',
  address: '225 N Cuyler St, Pampa, TX 79065',
  phone: '(806) 486-2561',
  email: 'info.redeemerpampa@gmail.com',
  facebookUrl: 'https://www.facebook.com/RedeemerPampa/',
  latitude: 35.5374381,
  longitude: -100.9650647,
  mapZoomLevel: 15,
};
