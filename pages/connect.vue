  ...
  <div>
    ...
    <div class="section">
      <div class="container">
        ...
        <p
          class="ml-8 content"
        >Join us for morning services. We start at 11:00am every Sunday morning.</p>
      </div>
    </div>
    <!--Gospel Community Description Section-->
    <div class="section">
      <div class="container">
        <h1 class="section-title" id="gospel-communities">Gospel Communities</h1>
        <div class="flex flex-col md:flex-row">
          ...
          <div class="flex-grow col">
            <p
              class="content ml-8 md:pr-6 md:border-r md:border-grey"
            >We at Redeemer Pampa don’t want our Sunday morning service to be the apex of our week. Instead it will simply be a part (definitely an important part, but still a just a part) of our week as a family. Gospel Communities (GC’s) are another vital part of Redeemer Pampa.</p>
          </div>
        </div>
        <p
          class="mt-6 mb-6 ml-8 text-right italic text-blue-dark content"
        >The goal of our GC’s is to see the gospel bear fruit in our lives as both individuals and as a community of people while we disciple one another, pray with/for one another, study scripture, and serve on mission together.</p>
